...
FROM requests 
WHERE requested_by = ? AND user_type = 'external'";
...
$payment_query = "SELECT 
    ...
    SUM(CASE WHEN pp.verified_status = 'Pending' OR pp.verified_status = 'Pending Payment Verification' THEN 1 ELSE 0 END) as pending_payments,
    SUM(CASE WHEN pp.verified_status = 'Verified' THEN 1 ELSE 0 END) as verified_payments,
    SUM(CASE WHEN pp.verified_status = 'Rejected' THEN 1 ELSE 0 END) as rejected_payments
FROM paymentproof pp
JOIN requests r ON pp.request_id = r.id
WHERE r.requested_by = ? AND r.user_type = 'external'";
...
$recent_requests_query = "SELECT 
    r.id, r.issue_title, r.category, r.status, r.created_at,
    pp.verified_status, pp.price
FROM requests r
LEFT JOIN paymentproof pp ON r.id = pp.request_id
WHERE r.requested_by = ? AND r.user_type = 'external'
...
$stmt->bind_param("i", $user_id);
$stmt->execute();
$recent_requests_result = $stmt->get_result();
$recent_requests = [];
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-banner">
            <div class="welcome-text">
                <h2>Welcome, <?php echo htmlspecialchars($_SESSION['fullname'] ?? 'External User'); ?>!</h2>
                <p>Here's an overview of your maintenance requests and payments.</p>
            </div>
            <div class="welcome-actions">
                <a href="external_user.php" class="action-btn">New Request</a>
            </div>
        </div>
        ...
        <div class="dashboard-sections">
            ...
            <div class="recent-section">
                <div class="section-header">
                    ...
                    <a href="view_requests.php" class="view-all">View All</a>
                </div>
                <div class="requests-list">
                    <?php if (!empty($recent_requests)): ?>
                        <?php foreach($recent_requests as $request): 
                            $status_class = '';
                            if ($request['status'] == 'In Progress') $status_class = 'status-inprogress';
                            if ($request['status'] == 'Completed') $status_class = 'status-completed';
                            if ($request['status'] == 'Pending Assignment') $status_class = 'status-pending';
                        ?>
                        <div class="request-item">
                            <h4><?php echo htmlspecialchars($request['issue_title']); ?></h4>
                            <p>Category: <?php echo htmlspecialchars($request['category']); ?></p>
                            <div class="request-meta">
                                <span class="status-badge <?php echo $status_class; ?>"><?php echo $request['status']; ?></span>
            ...
            <div class="quick-actions">
                ...
                <div class="action-buttons">
                    <a href="external_user.php" class="action-btn">
                        <i class="fas fa-plus"></i>
                        <span>New Request</span>
                    </a>
                    <a href="external_payment_upload.php" class="action-btn">
                        <i class="fas fa-upload"></i>
                        <span>Upload Payment</span>
                    </a>
                    <a href="view_requests.php" class="action-btn">
                        <i class="fas fa-list"></i>
                        <span>View All Requests</span>
                    </a>
                    <a href="external_payment_history.php" class="action-btn">
                ...
                <div class="payment-summary">
                    ...
                    <div class="payment-stat">
                        <span>Verified: </span>
                        <strong><?php echo $payment_stats['verified_payments'] ?? 0; ?></strong>
                    </div>
                    <div class="payment-stat">
                        <span>Rejected: </span>
                        <strong><?php echo $payment_stats['rejected_payments'] ?? 0; ?></strong>
                    </div>
                </div>
            </div>
        </div>
...
<footer>
    <div class="footer-inner">
        ...
        <div class="muted">
            <h3>Quick Links</h3>
            <a href="external_dashboard.php">Dashboard</a>
            <a href="external_user.php">Submit Request</a>
            <a href="view_requests.php">View Requests</a>
        </div>
        <div class="muted">
            <h3>Help & Support</h3>
